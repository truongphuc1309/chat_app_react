...
function LoadingFile({ data }) {
    return (
        <div className="flex justify-end mt-1">
            ...
            {data.type === 'voice' && (
                <div className="flex w-[40%] h-[60px] pl-[20px] items-center rounded-[20px_20px_0_20px] border-[2px] border-[var(--primary)] bg-[var(--third)]">
            ...
            {!['image', 'voice'].includes(data.type) && (
                <div className="flex items-center max-w-[50%] p-[4px_10px]  text-white break-word rounded-[20px_20px_0_20px] bg-[var(--primary)] ml-1">
